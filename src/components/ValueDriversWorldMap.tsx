...
const valueDrivers: ValueDriver[] = [
  {
    ...
    impact: "High",
    description:
      "Research and development, patents, intellectual property creation, and technical know-how driving innovation.",
    icon: Lightbulb,
    position: { x: "20%", y: "25%" }, // North America
  ...
  },
  {
    ...
    impact: "High",
    description:
      "Brand recognition, marketing strategies, customer relationships, and market positioning excellence.",
    icon: Target,
    position: { x: "50%", y: "25%" }, // Europe
    region: "Europe",
    color: "#8b5cf6",
  },
  {
    ...
    impact: "Medium",
    description:
      "Manufacturing processes, trade secrets, operational efficiency, and production methodologies.",
    icon: Settings,
    position: { x: "70%", y: "30%" }, // Asia
    region: "Asia Pacific",
    color: "#f59e0b",
  },
  {
    ...
    impact: "Medium",
    description:
      "Distribution networks, regulatory approvals, market entry strategies, and customer access channels.",
    icon: TrendingUp,
    position: { x: "55%", y: "56%" }, // Emerging Markets
  ...
  return (
    <div className="relative w-full h-[500px] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl border border-gray-200 overflow-hidden">
      ...
      {valueDrivers.map((driver) => {
        const bubbleSize = "w-16 h-16"; // Slightly larger for better visibility
        ...
        return (
          ...
          >
            ...
            {/* Tooltip */}
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <div className="bg-white/95 backdrop-blur-sm text-gray-900 px-4 py-3 rounded-lg shadow-xl border border-gray-200 text-sm whitespace-normal min-w-[220px] max-w-xs">
                <div className="font-semibold text-gray-900 mb-1">
                  {driver.name}
                </div>
                <div className="text-xs text-gray-600 mb-2">
                  Region: {driver.region} • Impact: {driver.impact}
                </div>
      ...
      {hoveredDriver &&
        (() => {
          ...
          const showOnLeft =
            hoveredDriver.bubbleRect.right + tooltipWidth + 15 >
            window.innerWidth;
              ...
              style={{
                ...
                top: Math.max(
                  ...
                  Math.min(
                    ...
                    hoveredDriver.bubbleRect.top +
                      hoveredDriver.bubbleRect.height / 2
                  )
                ),
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        ...
                        style={{ color: hoveredDriver.driver.color }}
                      >
