...
const researchTopics = [
  {
    ...
    relevanceScore: 95,
    summary:
      "Comprehensive analysis of manufacturing margins across APAC markets including China, India, and Southeast Asia.",
  },
  {
    ...
    relevanceScore: 88,
    summary:
      "Updated OECD guidelines addressing transfer pricing challenges in the digitalized economy.",
  },
  {
    ...
    relevanceScore: 92,
    summary:
      "Detailed comparable company analysis for automotive parts distribution across European markets.",
  },
  {
    ...
    relevanceScore: 87,
    summary:
      "Framework for Development, Enhancement, Maintenance, Protection, and Exploitation of intangibles.",
  },
  {
    ...
    relevanceScore: 78,
    summary:
      "Complete guide to EU transfer pricing documentation requirements and best practices.",
  },
  {
    ...
    relevanceScore: 84,
    summary:
      "Market benchmarks for cost-plus markup rates applicable to intercompany shared services.",
  },
];
...
const recentSearches = [
  ...
  },
  {
    id: 3,
    query:
      "What's the transfer pricing benchmarking range for software companies in India",
    category: "Benchmarking",
    icon: BarChart3,
    timestamp: "1 day ago",
  },
...
const lifeSciencesCases = [
  {
    ...
    caseSummary:
      "Medtronic Puerto Rico Operations Co. (MPROC) manufactured implantable cardiac & spinal devices. It paid royalties to U.S. parent for intangibles (patents, know-how, trademarks). IRS argued Medtronic underpaid royalties by shifting too much profits to Puerto Rico.",
    keyIssue: "What is the arm's-length royalty rate for device IP?",
    outcome:
      "The U.S. Tax Court initially crafted its own method to determine an arm's-length royalty after rejecting both IRS and Medtronic's approaches, leading to prolonged litigation and appeals.",
    details:
      "Court rejected pure CUT & CPM; crafted unspecified hybrid method, resulting in ~70% system profit to U.S and ~30% to PR.",
    keyTakeaway:
      "This teaches us that robust analysis and documentation for intangible licenses are critical – an insufficient method or support can result in years-long battles",
  ...
  },
  {
    ...
    caseSummary:
      "Amgen Manufacturing Ltd. (AML) in Puerto Rico produces biologics. IRS claimed Amgen shifted excessive profit to PR. Adjustments for 2010–2015: ~$10.7B (tax + penalties + interest). Amgen disputes, says allocations consistent with cost-sharing and arm's-length principles.",
    keyIssue:
      "How should U.S. vs. Puerto Rico returns be divided for biologic manufacturing?",
    outcome:
      "The case is still ongoing. This is one of the largest TP disputes on record and will be a Critical test case for DEMPE framework and Puerto Rico structures.",
    details:
      "The IRS arguments are that PR plant was contract-like manufacturer and hence bulk of profit should stay in U.S. where R&D, IP control, and DEMPE functions sit. Amgen argues that PR entity bore significant manufacturing, regulatory, and quality risks and therefore is entitled to high returns.",
    keyTakeaway:
      "The outcome could reshape profit allocation for pharma/biotech groups with offshore manufacturing.",
    takeawayColor: "bg-yellow-50 border-yellow-200 text-yellow-800",
  },
];
...
const relatedResearch = [
  ...
  },
  {
    ...
    description:
      "Development, Enhancement, Maintenance, Protection, Exploitation analysis",
  },
  {
    ...
    <div className="space-y-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl text-gray-900 mb-2">
          Key Transfer Pricing Disputes in Life Sciences
        </h1>
        <p className="text-gray-600">
          Transfer pricing disputes in the life sciences sector often involve
          complex intangible property valuations, cost- sharing arrangements,
          and profit allocation between manufacturing and R&D entities.
        </p>
      </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-yellow-500 pl-4">
                ...
                <div
                  className={`p-4 rounded-lg border ${case_item.takeawayColor}`}
                >
                  <p className="text-sm leading-relaxed">
                    {case_item.keyTakeaway}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
        ...
        <p className="text-gray-600 mb-6">
          Explore more transfer pricing research on related topics
        </p>
...
export default function ResearchPage() {
  ...
  const handleSearch = () => {
    if (searchQuery.trim()) {
      ...
      if (
        searchQuery ===
        "Summarise key transfer pricing disputes in life sciences"
      ) {
        ...
        <div className="flex flex-col flex-1">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                <h1 className="text-xl text-gray-900 mb-1">
                  <span className="text-blue-600">Transfer Pricing</span>{" "}
                  Research Details
                </h1>
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="bg-white/70 border-white/40 rounded-xl"
          ...
          <div className="flex-1 overflow-auto p-6">
            <Tabs
              ...
              onValueChange={setActiveResearchTab}
              className="space-y-6"
            >
                ...
                <Card className="bg-white/60 backdrop-blur-sm border-white/30">
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed mb-4">
                      ...
                      {selectedResearch.title.toLowerCase()}, focusing on
                    ...
                    <div className="space-y-3">
                      <div className="border-l-4 border-blue-500 pl-4">
                        ...
                        <p className="text-gray-700 text-sm">
                          Primary analysis results and implications for transfer
                          pricing strategy.
                        </p>
                      </div>
                      <div className="border-l-4 border-green-500 pl-4">
                        ...
                        <p className="text-gray-700 text-sm">
                          Actionable recommendations based on current market
                          conditions.
                        </p>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          Relevant OECD transfer pricing guidelines and their
                          application.
                        </p>
                      </div>
                      <div className="p-4 bg-green-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          Jurisdiction-specific requirements and compliance
                          obligations.
                        </p>
                      </div>
                    </div>
                        ...
                        >
                          <div>
                            ...
                            <p className="text-xs text-gray-600">
                              Additional resource for comprehensive
                              understanding
                            </p>
                          </div>
                          <Button
          ...
          <div className="p-6 bg-white/80 backdrop-blur-xl border-b border-white/20">
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600">
                {hasSearched
                  ? `Showing ${filteredTopics.length} research topics`
                  : "Explore popular research topics"}
              </span>
          ...
          <div className="flex-1 overflow-auto p-6">
            {showLifeSciencesCases ? (
              ...
              <div className="space-y-6">
                {/* Recent Searches */}
                <div>
                  <h2 className="text-lg mb-4 text-gray-800">
                    Recent Searches
                  </h2>
                  <div className="space-y-3">
                      ...
                      return (
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <h3 className="text-gray-900 group-hover:text-[#009FB8] transition-colors mb-2 leading-relaxed">
                              {search.query}
                            </h3>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {popularTopics.map((topic, index) => {
                      ...
                      const matchingTopic = researchTopics.find(
                        (rt) => rt.title === topic.title
                      );

                      return (
                        <Card
                          key={index}
                          className="group border border-gray-200 hover:shadow-md transition-all duration-200 hover:border-blue-200"
                        >
                          <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-3">
                                <div
                                  className={`w-12 h-6 rounded-full flex items-center justify-center text-sm ${getColorClasses(
                                    topic.color
                                  )}`}
                                >
                                  {topic.percentage}%
                                ...
                                <Button
                                  size="sm"
                                  onClick={() =>
                                    handleResearchSelect(matchingTopic || topic)
                                  }
                                  variant="login"
                                  className="rounded-xl"
                                >
              ...
              <div className="grid gap-4">
                {filteredTopics.map((topic, index) => (
                  <Card
                    key={index}
                    className="group border-0 bg-white/60 backdrop-blur-sm hover:bg-white/80 transition-all duration-300 hover:shadow-xl hover:scale-[1.02]"
                  >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-start gap-3 mb-3">
                            <div
                              className={`w-12 h-12 rounded-xl bg-gradient-to-r ${topic.color
                                .replace("400", "100")
                                .replace(
                                  "500",
                                  "200"
                                )} flex items-center justify-center flex-shrink-0 border border-white/50`}
                            >
