...
const supportActivities = [
  {
    ...
    icon: Building2,
    description:
      "Includes systems components such as accounting, finance, legal, public relations, quality control.",
  },
  {
    ...
    icon: ShoppingCart,
    description:
      "Includes the acquisition of raw materials, goods, services, and other external resources, as well as logistics coordination.",
  },
  {
    id: "customer-service",
    ...
    icon: HeadphonesIcon,
    description:
      "Processes that are offered after the product has been sold and delivered, such as customer service and support.",
  },
];
...
const primaryActivities = [
  {
    ...
    icon: Lightbulb,
    description:
      "Includes all research and development, intellectual property creation, software and hardware upgrades, and technical know-how.",
  },
  {
    id: "production",
    name: "Production",
    ...
    icon: Settings,
    description:
      "Processes that convert raw materials, labor, or energy into finished goods or services.",
  },
  {
    id: "marketing-sales",
...
export default function ValueChainAnalysis() {
  ...
  const supportTotal = supportActivities.reduce(
    (sum, activity) => sum + activity.percentage,
    0
  );
  const primaryTotal = primaryActivities.reduce(
    (sum, activity) => sum + activity.percentage,
    0
  );
                ...
                <div className="relative flex justify-between">
                  {steps.map((step, index) => {
                    ...
                    return (
                      <div
                        key={step.id}
                        className="relative flex flex-col items-center max-w-xs cursor-pointer"
                      ...
                      >
                        ...
                        <div className="text-center mt-4 px-2">
                          <h4
                            className={`font-semibold text-sm mb-1 transition-colors duration-200 text-gray-600`}
                          >
                            {step.name}
                          </h4>
                          <p
                            className={`text-xs leading-relaxed transition-colors duration-200 text-gray-500`}
                          >
                            {step.description}
                          </p>
                        </div>
                        ...
                        {index < steps.length - 1 && (
                          <div
                            className={`absolute top-8 left-8 w-full h-0.5 transition-all duration-500 ${
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/20">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Comprehensive analysis of value-generating activities
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      <div className="flex rounded-lg overflow-hidden shadow-sm border border-gray-200 h-16">
                        {supportActivities.map((activity, index) => {
                          const IconComponent = activity.icon;
                          const widthPercentage =
                            (activity.percentage / supportTotal) * 100;
                          const colors = [
                ...
                <div className="flex items-center justify-center mb-8">
                  <div className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-50 to-emerald-50 rounded-full border border-blue-200">
                    ...
                    <div className="relative">
                      <div className="flex rounded-lg overflow-hidden shadow-sm border border-gray-200 h-16">
                        {primaryActivities.map((activity, index) => {
                          const IconComponent = activity.icon;
                          const widthPercentage =
                            (activity.percentage / primaryTotal) * 100;
                          const colors = [
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/20">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Global distribution of critical value-creating activities
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <div className="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-600">
                        Research, patents, and technical know-how concentrated
                        in North America
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-600">
                        Brand recognition and customer relationships driving
                        value
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-orange-50 to-yellow-50 border border-orange-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-600">
                        Value drivers distributed across key pharmaceutical
                        markets
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8 p-6 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200">
                  <h4 className="font-semibold text-gray-900 mb-3">
                    Pharma/Med-Tech Industry Analysis
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                    <div>
                      <p className="font-medium mb-2">
                        Pre-Peer Analysis Findings:
                      </p>
                      <ul className="space-y-1 text-xs">
                        <li>
                          • IP development concentrated in innovation hubs
                        </li>
                        <li>
                          • Brand/Marketing leverages European regulatory
                          expertise
                        </li>
                        <li>
                          • Operations know-how distributed across manufacturing
                          centers
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-1 text-xs">
                        <li>
                          • Transfer pricing should reflect IP value
                          concentration
                        </li>
                        <li>
                          • Marketing intangibles justify European profit
                          allocation
                        </li>
                        <li>
                          • Manufacturing efficiency drives Asia-Pacific
                          positioning
                        </li>
                      </ul>
                    </div>
            ...
            <div className="mb-8">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/20">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900">
                      Peer Analysis - Value Driver Comparison
                    </h2>
                    <p className="text-gray-600">
                      Horizontal bar chart comparing value driver percentages
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={index} className="flex items-center gap-4">
                        {/* Company Name Label */}
                        <div
                          className={`w-24 text-right flex-shrink-0 leading-tight ${
                            peer.isYou
                        ...
                        <div className="flex-1 max-w-2xl">
                          <div className="relative flex rounded-full overflow-hidden h-12 shadow-md border border-gray-100">
                            ...
                            <div
                              className={`${
                                peer.isMedian ? "bg-gray-700" : "bg-teal-400"
                            ...
                            <div
                              className={`${
                                peer.isMedian ? "bg-gray-600" : "bg-sky-500"
                              } flex items-center justify-center text-white font-semibold text-sm relative group transition-all duration-200`}
                            ...
                            <div
                              className={`${
                                peer.isMedian ? "bg-gray-500" : "bg-indigo-500"
                              } flex items-center justify-center text-white font-semibold text-sm relative group transition-all duration-200`}
                            ...
                            <div
                              className={`${
                                peer.isMedian ? "bg-gray-800" : "bg-purple-400"
                              } flex items-center justify-center text-white font-semibold text-sm relative group transition-all duration-200`}
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 rounded-xl bg-gray-50 border border-gray-200">
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li>
                        • Your IP & R&D allocation is above industry median
                      </li>
                      <li>• Brand/Marketing investment below peers average</li>
                      <li>
                        • Market access strategy aligns with top performers
                      </li>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/20">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Determine optimal profit allocation across activities
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-6">
                      Global Profit Allocation Strategy
                    </h3>
                    ...
                    <div className="relative w-full h-[500px] bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 rounded-2xl border border-gray-200 overflow-hidden mb-8">
                      ...
                      {/* <div className="absolute top-4 left-8 text-xs font-medium text-gray-600">
                        North America
                      </div>
                      <div className="absolute top-4 left-1/2 transform -translate-x-1/2 text-xs font-medium text-gray-600">
                        Europe
                      </div>
                      <div className="absolute top-4 right-8 text-xs font-medium text-gray-600">
                        Asia Pacific
                      </div>
                      <div className="absolute bottom-4 right-1/3 text-xs font-medium text-gray-600">
                        Other Markets
                      </div> */}
                      ...
                      {[
                        ...
                        const bubbleSize = "w-16 h-16"; // You can scale this based on percentage if needed
                        ...
                        return (
                          <div
                            ...
                            style={{
                              top: regionData.position.y,
                              left: regionData.position.x,
                              zIndex: 10,
                            }}
                          >
                            <div className="flex flex-col items-center space-y-2">
                              ...
                              >
                                <regionData.icon className="w-8 h-8 text-white" />
